...
| [`GridBarcodeScanner`](Samples/GridBarcodeScanner) | This sample demonstrates a multi-phase pipeline for decoding a large barcode grid from a single image, maximizing the decode rate with low latency. |
